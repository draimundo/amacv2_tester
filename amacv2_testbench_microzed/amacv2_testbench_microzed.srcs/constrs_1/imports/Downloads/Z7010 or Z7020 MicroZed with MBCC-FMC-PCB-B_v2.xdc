...
# User LEDs - Bank 34
# ----------------------------------------------------------------------------
set_property PACKAGE_PIN R19 [get_ports LED0]
set_property PACKAGE_PIN V13 [get_ports LED1]
...
set_property PACKAGE_PIN P19 [get_ports LDx1en]
set_property PACKAGE_PIN N18 [get_ports LDx0en]
set_property PACKAGE_PIN P20 [get_ports DCDCadj]
set_property PACKAGE_PIN N20 [get_ports OFin]
set_property PACKAGE_PIN R14 [get_ports OFout]
set_property PACKAGE_PIN P14 [get_ports RO_PG_O]
set_property PACKAGE_PIN Y17 [get_ports LDy0en]
set_property PACKAGE_PIN Y16 [get_ports LDx2en]
set_property PACKAGE_PIN Y14 [get_ports RESETB]
set_property PACKAGE_PIN W14 [get_ports GPO]
set_property PACKAGE_PIN U17 [get_ports LAM]
set_property PACKAGE_PIN T16 [get_ports GPI]
set_property PACKAGE_PIN U15 [get_ports {ID[4]}]
set_property PACKAGE_PIN U14 [get_ports DCDCen]
set_property PACKAGE_PIN U20 [get_ports LDy2en]
set_property PACKAGE_PIN T20 [get_ports LDy1en]
set_property PACKAGE_PIN W20 [get_ports MPM_MUX_EN]
set_property PACKAGE_PIN V20 [get_ports PGOOD]
set_property PACKAGE_PIN Y18 [get_ports CMD_OUT_P]
set_property PACKAGE_PIN Y19 [get_ports CMD_OUT_N]
set_property PACKAGE_PIN W16 [get_ports {ID[2]}]
set_property PACKAGE_PIN V16 [get_ports {ID[3]}]
set_property PACKAGE_PIN R17 [get_ports SSSHy]
set_property PACKAGE_PIN R16 [get_ports SSSHx]
#set_property PACKAGE_PIN R18 [get_ports {LA13_N}];  # "R18.JX1_LVDS_19_N.JX1.70.LA13_N"
set_property PACKAGE_PIN T17 [get_ports HVSW_MUX_EN]
set_property PACKAGE_PIN V18 [get_ports HVOSC1]
set_property PACKAGE_PIN V17 [get_ports HVOSC0]
set_property PACKAGE_PIN W19 [get_ports {ID[0]}]
set_property PACKAGE_PIN W18 [get_ports {ID[1]}]
set_property PACKAGE_PIN P18 [get_ports HrstBy]
set_property PACKAGE_PIN N17 [get_ports HrstBx]
...
set_property PACKAGE_PIN H18 [get_ports HVOSC3]
set_property PACKAGE_PIN J18 [get_ports HVOSC2]
set_property PACKAGE_PIN D18 [get_ports spi_rtl_io0_io]
set_property PACKAGE_PIN E17 [get_ports spi_rtl_sck_io]
set_property PACKAGE_PIN D20 [get_ports LV_EN_2V5]
set_property PACKAGE_PIN D19 [get_ports LD_EN_DVDD]
set_property PACKAGE_PIN E19 [get_ports {spi_rtl_ss_io[0]}]
set_property PACKAGE_PIN E18 [get_ports spi_rtl_io1_io]
set_property PACKAGE_PIN F17 [get_ports LV_EN_VN5]
set_property PACKAGE_PIN F16 [get_ports LV_EN_VP5]
...
set_property PACKAGE_PIN M20 [get_ports {spi_rtl_ss_io[2]}]
set_property PACKAGE_PIN M19 [get_ports {spi_rtl_ss_io[1]}]
set_property PACKAGE_PIN M18 [get_ports LV_EN_AVEE]
set_property PACKAGE_PIN M17 [get_ports LV_EN_AVDD5]
...
set_property PACKAGE_PIN G17 [get_ports CLKOUT]
set_property PACKAGE_PIN F20 [get_ports {spi_rtl_ss_io[4]}]
set_property PACKAGE_PIN F19 [get_ports {spi_rtl_ss_io[3]}]
set_property PACKAGE_PIN H20 [get_ports ADC_CNV]
set_property PACKAGE_PIN J20 [get_ports LV_EN_AVCC]
set_property PACKAGE_PIN J14 [get_ports {spi_rtl_ss_io[6]}]
set_property PACKAGE_PIN K14 [get_ports {spi_rtl_ss_io[5]}]
set_property PACKAGE_PIN G15 [get_ports {MPM_MUX[1]}]
set_property PACKAGE_PIN H15 [get_ports {MPM_MUX[0]}]
#set_property PACKAGE_PIN N16 [get_ports {LA32_N}];  # "N16.JX2_LVDS_20_N.JX2.83.LA32_N"
set_property PACKAGE_PIN N15 [get_ports {spi_rtl_ss_io[7]}]
#set_property PACKAGE_PIN L15 [get_ports {LA33_N}];  # "L15.JX2_LVDS_21_N.JX2.84.LA33_N"
set_property PACKAGE_PIN L14 [get_ports {MPM_MUX[2]}]
...
set_property PACKAGE_PIN V15 [get_ports CMD_IN_P]
set_property PACKAGE_PIN W15 [get_ports CMD_IN_N]
