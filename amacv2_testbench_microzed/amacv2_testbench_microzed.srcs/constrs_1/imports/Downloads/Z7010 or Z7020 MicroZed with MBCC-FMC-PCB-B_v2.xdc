...
set_property PACKAGE_PIN W15 [get_ports FPGA_CMD_IN_N]
set_property PACKAGE_PIN V15 [get_ports FPGA_CMD_IN_P]
...
set_property PACKAGE_PIN W20 [get_ports FPGA_HVOSC0]
set_property PACKAGE_PIN V20 [get_ports PGOOD]
set_property PACKAGE_PIN Y19 [get_ports FPGA_CMD_OUT_N]
set_property PACKAGE_PIN Y18 [get_ports FPGA_CMD_OUT_P]
...
set_property PACKAGE_PIN R18 [get_ports FPGA_HVOSC2]
set_property PACKAGE_PIN T17 [get_ports FPGA_HVOSC1]
set_property PACKAGE_PIN V18 [get_ports FPGA_CLKOUT]
set_property PACKAGE_PIN V17 [get_ports FPGA_HVOSC3]
...
set_property PACKAGE_PIN D18 [get_ports SDI]
set_property PACKAGE_PIN E17 [get_ports SCLK]
set_property PACKAGE_PIN D20 [get_ports LD_EN_DCDC]
set_property PACKAGE_PIN D19 [get_ports LD_EN_DVDD]
set_property PACKAGE_PIN E19 [get_ports DPOT_CS0]
set_property PACKAGE_PIN E18 [get_ports SDO]
set_property PACKAGE_PIN F17 [get_ports LD_EN_HI]
set_property PACKAGE_PIN F16 [get_ports LD_EN_HV]
...
set_property PACKAGE_PIN M20 [get_ports DPOT_CS2]
set_property PACKAGE_PIN M19 [get_ports DPOT_CS1]
set_property PACKAGE_PIN M18 [get_ports LD_EN_3V3]
set_property PACKAGE_PIN M17 [get_ports LD_EN_5]
...
set_property PACKAGE_PIN F20 [get_ports DAC_CS1]
set_property PACKAGE_PIN F19 [get_ports DAC_CS0]
set_property PACKAGE_PIN H20 [get_ports LD_EN_1V8]
set_property PACKAGE_PIN J20 [get_ports LD_EN_2V5]
set_property PACKAGE_PIN J14 [get_ports ADC_CS1]
set_property PACKAGE_PIN K14 [get_ports ADC_CS0]
...
set_property PACKAGE_PIN N16 [get_ports FPGA_ADC_CNV]
set_property PACKAGE_PIN N15 [get_ports ADC_CS2]
set_property PACKAGE_PIN L15 [get_ports I2C_scl_io]
set_property PACKAGE_PIN L14 [get_ports I2C_sda_io]
